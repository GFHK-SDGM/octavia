...
*
* This module is also released standalone as `@ltgc/midi-converter-ecosystem` on NPM and JSR to allow transitioning off said ecosystems and for SEO. This module does **not** incorporate code generated by LLMs.
*
* @example
* ```
* // Colxi MIDI Parser
